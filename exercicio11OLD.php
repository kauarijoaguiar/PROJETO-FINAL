...
<body>
    ...
    $grupo = $db->query("SELECT * FROM GRUPO WHERE ATIVO=1");
    ...
    while ($listaGrupos = $grupo->fetchArray()) {
        echo "<option value=\"" . $listaGrupos["CODIGO"] . "\">" . $listaGrupos["NOMEGRUPO"] . "</option>";
    }        
    echo "</select> 
            nos últimos
