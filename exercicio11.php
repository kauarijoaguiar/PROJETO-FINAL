...
<body>
    ...
    echo 'window.location.href = (window.location.href).replace("exercicio11.php", "exercicio10Table.php?NUMCURTIDAS="+numCurtidas+"&PAIS="+pais+"&HORAS="+horas+"&DIAS="+numDias);';
    echo '}';
    echo '</script>';
